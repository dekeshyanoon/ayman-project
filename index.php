    ...
    <header class="header">
        <nav>
            <ul>
                ...
                <li><a href="courses.php" class="animate__animated animate__fadeIn">الدورات</a></li>
                <li><a href="Login.php" class="animate__animated animate__fadeIn">تسجيل الدخول</a></li>
                <li><a href="register.php" class="animate__animated animate__fadeIn">تسجيل جديد</a></li>
                <li><a href="admin-dashboard.php" class="animate__animated animate__fadeIn">لوحة التحكم</a></li>
            </ul>
        </nav>
    </header>
